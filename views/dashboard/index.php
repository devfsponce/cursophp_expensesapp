                            ...
                            <div class="total-expense">
                                ...
                                if ($totalThisMonth === NULL) {
                                    ...
                                    <span class="<?php echo ($user->getBudget() < $totalThisMonth) ? 'broken' : '' ?>">
                                        <?php echo number_format($totalThisMonth, 2); ?>
                                    </span>
                                <?php } ?>
                            </div>
                        </div>
                            ...
                            <div class="total-expense">
                                    <?php
                                        if($totalThisMonth === NULL){
                                            ...
                                            <span>
                                                <?php
                                                    $gap = $user->getBusdget() - $totalThisMonth;
                                                    if($gap < 0){
                                                        echo "-$";
                                                    }else{
                                                        echo "$";
                        ...
                        <h2>Registros más recientes</h2>
                            <?php 
                                if($expenses === NULL){
                                    ...
                                    echo '<div class="more-container><a href=""expenses">Ver todos los gastos<i class="material-icons">"';
                                }                                
                                ?>

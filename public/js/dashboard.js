...
async function getContent() {
    const html = await fetch('http://localhost:8080/expense-app-mvc/expenses/create').then(res => res.text());
    return html;
}
...
async function drawChart() {
    const http = await fetch('http://localhost:8080/expense-app-mvc/expenses/getExpensesJSON')
        .then(json => json.json())
        .then(res => res);
